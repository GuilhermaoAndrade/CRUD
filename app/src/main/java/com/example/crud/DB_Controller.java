...
public class DB_Controller extends SQLiteOpenHelper {
    ...
    private static final String DB_TABLE_ITEMVENDA = "Reuniao";
...
//            ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "+NAME + " TEXT "+ ")";
    ...
    public void  insert_produto(ModeloCliente MC){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(NAME, MC.getCliente());
    ...
    public void list_all_produto(TextView textView){
        Cursor cursor = this.getReadableDatabase().rawQuery("SELECT * FROM NPRODUTO", null);
        textView.setText("");
    ...
    public void  insert_venda (ModeloFuncionario MF){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(NAME, MF.getFuncionario());
    ...
    public void list_all_data(TextView textView){
    ...
    public void delete_itemvenda(String idagenda){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(DB_TABLE_ITEMVENDA, "ID = ?",new String[]{idagenda});
    ...
    public void listagenda(TextView textView){
        Cursor cursor = this.getReadableDatabase().rawQuery("SELECT * FROM AGENDA", null);
        textView.setText("");
        while(cursor.moveToNext()){
